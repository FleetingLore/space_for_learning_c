...
int main() {
    // 单位: 万元
    const float const_1 = 5000.0; // 建设项目工程费用
    const float const_2 = 1000.0; // 工程建设其他费用
    const float const_3 = 5000.0; // 计划完成每年投资
    ...
    /**
     * 总费用 = (项目工程费用 + 建设其他费用) x (1 + 基本预备费率)
     * 第二年差预备费 = 总费用 x 计划每年完成投资 x (1 + 年均投资价格上涨率 5%)
     */
